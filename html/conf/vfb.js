...
setTimeout(function(){ window.setToolTips(); }, 3000);
setTimeout(function(){ if (window.templateID == undefined || eval(window.templateID).children.length < 2){location.reload();}; }, 60000);
