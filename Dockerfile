FROM nginx:stable
ENV VFB_MAIN_SERVER=v2-preview-jt1.virtualflybrain.org
ENV VFB_PDB_SERVER=pdb-preview-jt1.virtualflybrain.org
ENV VFB_OWL_SERVER=owl-preview-jt1.virtualflybrain.org
